...
//TODO: Import your_package_hierarchy.R
...
public class UiUtil
{
    ...
    public static boolean setSensor(int TYPE, Activity activity, SensorEventListener sensorEventListener)
    {
        Sensor sensor = null;
    ...
    public static void showErrorDialog(Activity a, String title, String errorMessage)
    {
        showAlertDialog(a, title, errorMessage, "Dismiss", R.color.colorPrimaryDark, R.color.colorAccent);
    }
